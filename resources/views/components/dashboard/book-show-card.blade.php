<div class="container max-w-screen-lg mx-auto">
  <div>
    <div class="rounded shadow-lg p-4 px-4 md:p-8 mb-6 bg-white shadow-2xl">
      ...
      <!-- User Info Section -->
      <div class="mb-6 bg-gray-100 p-4 rounded-md shadow-sm">
        <p class="text-xl font-semibold text-gray-800">Posted by: {{ $book->user->firstName }}</p>
        <p class="text-sm text-gray-600">{{ $book->user->email}}</p>
      </div>
        ...
        <div class="lg:col-span-2">
          <div class="space-y-4">
            ...
            <div class="flex gap-4">
                <a href="{{route('books.edit',$book->id)}}" type="button" class="text-black bg-white border border-blue-800 hover:bg-blue-800 hover:text-white  font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 duration-300  ">
