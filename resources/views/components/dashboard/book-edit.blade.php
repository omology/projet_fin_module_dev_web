    ...
    <div class="mx-auto p-20 bg-white rounded-md">
        ...
        enctype="multipart/form-data">
            ...
            <div class="mb-5">
                ...
                <input type="email" name="email" id="email" placeholder="Enter your email" value="{{$book->user->email}}"
                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    @error('email')
              <div class="alert alert-danger text-sm text-red-500">{{ $message }}*</div>
          @enderror
            ...
            <label class="mb-5 block text-xl font-semibold text-[#07074D]">
                ...
                <label class="mb-5 block text-xl font-semibold text-[#07074D]" for="description">
                    Description
                        ...
                        id="description" cols="30" rows="10" class=" h-40 w-full resize-none rounded-md border border-slate-300 p-5 font-semibold text-gray-800">{{$book->description}}</textarea>
@error('description')
              <div class="alert alert-danger text-sm text-red-500">{{ $message }}*</div>
          @enderror
                </div>
