	...
	<div class="mx-auto ">
		<div class="flex justify-center px-6 py-8 ">
			...
			<div class="w-full xl:w-3/4 lg:w-11/12 flex
             ...
             shadow-lg ">
				<!-- Col -->
				<div class="w-full  bg-gray-400 dark:bg-gray-800 hidden lg:block lg:w-5/12 bg-cover rounded-l-lg"
					style="background-image: url('https://img.freepik.com/photos-gratuite/vue-dessus-composition-minimale-livres_23-2148851092.jpg')"></div>
				<!-- Col -->
				<div class="w-full lg:w-7/12 bg-white dark:bg-gray-700 px-5 rounded-lg lg:rounded-l-none">
					<h3 class="py-4 text-2xl text-center text-gray-800 dark:text-white">Create an Account!</h3>
					<form
                    method="POST"
                    action="{{route('auth.register.create')}}"
                     class="px-8  mb-4 bg-white dark:bg-gray-800 rounded">
                     @csrf
						...
						<div class="">
							...
							<input
                                class="w-full px-3 py-2 mb-1 text-sm leading-tight text-gray-700 dark:text-white border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                id="email"
                                name="email"
                                type="email"
                                value="{{old('email')}}"
						...
						<div class="mb-4 md:flex md:justify-between">
							<div class="mb-4 md:mr-2 md:mb-0">
								...
								<input
                                    class="w-full px-3 py-2 mb-1 text-sm leading-tight text-gray-700 dark:text-white  rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                    id="password"
                                    name="password"
                                    type="password"
							...
							<div class="md:ml-2">
								<label class="block mb-1 text-sm font-bold text-gray-700 dark:text-white" for="confirm_password">
                                    Confirm Password
                                </label>
								<input
                                    class="w-full px-3 py-2 mb-1 text-sm leading-tight text-gray-700 dark:text-white border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
						...
						<div class="mb-4 text-center">
							<button
                                class="w-full px-4 py-2 font-bold text-white bg-blue-500 rounded-md hover:bg-blue-700 dark:bg-blue-700 dark:text-white dark:hover:bg-blue-900 focus:outline-none focus:shadow-outline"
                                type="submit"
                            >
                                Register Account
                            </button>
